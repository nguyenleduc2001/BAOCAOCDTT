                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text" name="detail" id="detail" class="form-control" value="{{ old('detail') }}"
                                    class="form-control"></textarea>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pricesale" id="pricesale" value="{{ old('pricesale') }}"
                                    class="form-control">
                                @if ($errors->has('pricesale'))
                                    <div class="text-danger">
                                        {{ $errors->first('pricesale') }}
                                    </div>
                                @endif
                            </div>
                            <div class="mb-3">
