                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('import.create') }}" class="btn btn-sm btn-success">Thêm</a>
                                <a href="{{ route('import.trash') }}" class="btn btn-sm btn-danger"><i
                            ...
                            <tbody>
                                @foreach ($list as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('images/import/' . $row->image) }}" class="img-fluid"
                                                alt="{{ $row->image }}">
                                        </td>
                                        <td>{{ $row->name }}</td>
                                        ...
                                        <td>
                                            <a href="{{ route('import.show', ['import' => $row->id]) }}"
                                                class="btn btn-sm btn-success">
                                                <i class="fas fa-toggle-on"></i></a>
                                            <a href="{{ route('import.edit', ['import' => $row->id]) }}"
                                                class="btn btn-sm btn-info"> <i class="fas fa-wrench"></i></a>
                                            <a href="{{ route('import.show', ['import' => $row->id]) }}"
                                                class="btn btn-sm btn-danger "><i class="far fa-eye"></i></a>
                                            <a href="{{ route('import.trash', ['import' => $row->id]) }}"
